    ...
    <div class="row justify-content-center">
        <div class="col-md-9">
            <div class="card">
                ...
                @else
                {!! Form::open(['method' => 'PUT', 'route' => ['category.update',$category->id], 'class' =>
                'form-horizontal']) !!}
                @endif
                ...
                <div class="form-group">
                    ...
                    {!! Form::text('slug', isset($category) ? $category->slug : '', ['class' => 'form-control', 'id'=>
                    'convert_slug']) !!}
                </div>
                <div class="form-group">
                    {!! Form::label('des', 'Mô tả', []) !!}
                    {!! Form::textarea('des', isset($category) ? $category->des : '', ['class' => 'form-control',
                    'placeholder' => 'Mô tả']) !!}
                </div>
                <div class="form-group">
                    {!! Form::label('staus', 'Trạng Thái', []) !!}
                    {!! Form::select('status',['1'=> 'Hiện thị', '0'=> 'Không hiện thị'], isset($category) ?
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                ['category.destroy',$cate->id],'onsubmit'=>'return confirm("Xóa hay không")']) !!}
